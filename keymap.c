...
[_DVORAK] = LAYOUT( \
  ...
  MY_WIN, XXXXXXX, ADJUST,  MY_CTRL, MY_LOW,  Sp_lS,  	     Sp_rS,   MY_RAISE,MY_ALT,  XXXXXXX, XXXXXXX, XXXXXXX \
),
...
[_CYRILIC] = LAYOUT( \
  ...
  MY_WIN,  XXXXXXX, ADJUST,  MY_CTRL, MY_LOW,  Sp_SH,       Sp_SH ,  MY_RAISE,A_HD,    XXXXXXX, XXXXXXX, XXXXXXX \
),
...
[_LOWER] = LAYOUT( \
  ...
  MY_LANG, KC_LEFT, KC_RGHT, KC_DOWN, KC_UP,   __I,         KC_0,    KC_1,    KC_2,    KC_3,    KC_EQL,  KC_ENT, \
  MY_SCRN, CT_C,    CT_V,    CS_TAB,  CT_TAB,  AL_Z,	    KC_SLSH, KC_4,    KC_5,    KC_6,    KC_PPLS, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     Sp_SH,   KC_BSPC, KC_PAST, XXXXXXX, XXXXXXX, XXXXXXX \
),
...
[_RAISE] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, MY_RUSL, MY_ENGG, Sp_SH,	    Sp_SH,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX \
),
...
[_ADJUST] =  LAYOUT( \
  ...
  BL_DEC,  XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG, TURN_L,	    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,	    DVO,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,	    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX\
),
...
[_DVO] = LAYOUT( \
  ...
  MY_RUSL, XXXXXXX, ADJUST,  MY_CTRL, MY_LOW,  Sp_lSs,  	     Sp_rSs,   MY_RAISE,MY_ALT,  XXXXXXX, XXXXXXX, XXXXXXX \
),
...
[_EDITOR] =  LAYOUT( \
  ...
  MY_LANG, _A,      _O,      _E,      _U,      _I,   	    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
...
[_TELHK] =  LAYOUT( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,	    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, CT_A,    CT_X,    TURN_L,	    XXXXXXX, CT_7, 	  CT_8,    CT_9,    CT_BSPC, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, CT_DOWN, CT_UP,   XXXXXXX,	    XXXXXXX, CT_1,    CT_2,    CT_3,    XXXXXXX, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,	    XXXXXXX, CT_4,    CT_5,    CT_6,    XXXXXXX, XXXXXXX,\
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,	    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX\
)
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) { 
 ...
 switch (keycode) {
    ...
    case DVO:
      if (record->event.pressed) {
        persistent_default_layer_set(1UL<<_DVO);
      }
      return false;
      break;
